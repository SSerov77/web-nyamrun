...
class Address(models.Model):
    country = models.CharField(max_length=255, default="Россия", verbose_name="Страна")
    city = models.CharField(max_length=255, default="Не указан", verbose_name="Город")
    street = models.CharField(max_length=255, default="Не указан", verbose_name="Улица")
    house_number = models.CharField(
        max_length=50, default="Не указан", verbose_name="Дом"
    )
